...
public enum ModArmorMaterials implements ArmorMaterial {
    COPPER("copper", 11, new int[] { 2, 4, 3, 1 }, 8, SoundEvents.ITEM_ARMOR_EQUIP_IRON,
            0.0f, 0.0f, () -> Ingredient.ofItems(Items.COPPER_INGOT));

    /** Netherite values for future reference
    NETHERITE("netherite", 37, new int[] { 3, 8, 6, 3 }, 15, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE,
    ...
    **/
    ...
    public String getName() {
        return ShuckleQOL.MOD_ID + ":" + this.name;
    }
