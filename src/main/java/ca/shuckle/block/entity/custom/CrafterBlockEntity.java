...
public class CrafterBlockEntity extends LootableContainerBlockEntity implements ExtendedScreenHandlerFactory {
    ...
    public CrafterBlockEntity(BlockPos pos, BlockState state) {
        ...
        ((CraftingInventoryMixin) craftingInventory).setInventory(this.inputStacks);
    ...
    public ScreenHandler createScreenHandler(int syncId, PlayerInventory playerInventory) {
        return new CrafterScreenHandler(syncId, playerInventory, this.getCraftingInventory(), this.propertyDelegate);
    }
    ...
    public DefaultedList<ItemStack> getInputStacks() {
        return this.inputStacks;
    }
